...
export const paymentResponse = (request, response) =>{
         ...
         if(isVerifySignature)
         {
            ...
            paytmchecksum.generateSignature(request.body,'bKMfNxPPf_QdZppa').then(function(checksum){
                paytmParams['CHECKSUMHASH'] = checksum;

                const post_data = JSON_stringify(paytmParams);
                const options = {
